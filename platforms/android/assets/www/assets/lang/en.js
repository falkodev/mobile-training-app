...
faq_question_6_content = "If you think this site is a good idea, you can thank the author {{{<a href='index.html#contact'>}}}with an encouraging message.{{{</a>}}}{{{<br>}}}{{{<br>}}}You can also talk about this site to those around you. It is a way to make it known to others and to push me to improve it.{{{<br>}}}{{{<br>}}}And for those who want to buy me a coffee, {{{<a href='index.html#donate'>}}}click here ;){{{</a>}}}"
...
selected_utc_phrase_1 = 'You have chosen to receive your email everyday at '
selected_utc_phrase_2 = '.00 according to the timezone UTC '
btn_save = 'Save'
btn_next = 'Next step'
btn_last = 'Last step'
btn_previous = 'Back'
...
subscribe_text_1 = "4 steps are required to subscribe."
...
show_other_lang = 'Other languages'
hide_other_lang = 'Hide'
...
yes = 'Yes'
no = 'No'
subscribe_create_1 = 'Thank you'
subscribe_create_2 = 'for your registration. You will receive in a few minutes a confirmation email at <b>'
subscribe_create_3 = '</b>. If it is not the case, please check the "Spams" folder in your email account.<br><br>You chose to receive the Bible reading every '
subscribe_create_4 = '. Your password to access your account on the website is <b>'
subscribe_create_5 = '</b><br><br>You will be able to modify every parameter (email address, password, reception days, first day of your reading\'s week) in your account. If you have any question, do not hesitate to use the contact form.<br><br>Have a nice Bible reading and we hope to see you soon.<br><br>The JW Reading administrator</p>'
login_validate = 'The email address or the password is wrong'
pwd_validate = 'The password is wrong'
email_validate = 'This email address is not registered as an account. You can create one with the "Subscribe" menu'
logout_validate = 'You have been logged out'
connection_validate = 'It seems you are not connected to the internet. Please check your connection before going further'
email_existing_validate = 'This email address is already used. If you have forgotten your password, please use the link "Forgotten password" in the login menu or the contact form to inform me about a problem'
email_empty_validate = "Please enter an email address"
email_incorrect_validate = 'This email address is not valid'
change_password_empty_validate = 'The password cannot be empty'
change_password_length_validate = 'The password needs to be at leat 4 characters long'
change_password_match_validate = 'Both password fields do not match'
change_password_fail_validate = 'Unfortunately, the password modification failed. Please, try again later'
change_password_success_validate = 'The password has been modified'
success_account_validate = 'Your modifications have been saved'
error_account_validate = 'Error while saving data'
day_validate = 'Please choose at least one day et select it as first day'
reception_validate = 'You must choose at least one reception mode'
reception_mode = 'What reception mode ?'
reception_email = 'Email'
reception_app = 'Mobile application'
daily_portion = 'Daily reading'
daily_text = 'Daily text'
news = 'News JW.org'
read_all_news = 'Read all news'
weekly_reading = 'Weekly reading'
today_reading_from = 'Today\'s portion goes from'
today_reading_to = 'to'
not_today_validate = 'According to your configuration, today is not a reading day'
display_previous_verses = 'Display previous verses'
display_next_verses = 'Display next verses'
hide_previous_verses = 'Hide previous verses'
hide_next_verses = 'Hide next verses'
...
donate_dashboard = "Support the JW Reading project"
donate_title = "Support the JW Reading project"
donate_button_paypal = "Donate with Paypal"
donate_button_tib = "Donate with Tib"
donate_text = "You can support this project by your participation. For example, by offering your help for translating the interface in a language you master, by enriching the FAQ or by pointing bugs out.{{{<br>}}}{{{<br>}}}If you appreciate the work done, you can make a contribution, even a few cents. You will need a Paypal or a Tib account and the money will be used to pay for website hosting, mobile applications submission, code maintenance and new functionalities on the project.{{{<br>}}}{{{<br>}}}Thank you for your support. It is greatly appreciated and encourages me to continue."
rate_app_title = "Notification"
rate_app_message = "If you enjoy using the JW Reading app, would you mind taking a minute to rate it ?{{{<br>}}}Thanks for your support."
