var accountView = function () {
            ...
            success:function(result)
            {
                if(hash == "account") { // existing account
                    if(result.substr(0,2) == 'OK') { 
                        ...
                        sessionUserData = JSON.parse(localStorage.getItem("sessionUserData"));
                        //hide back and submit buttons and show 'back to home' button
                        $('#backToAccountThirdBtn').hide();
                        $('#accountFourthBtn').hide();
                        $('#backToHome').show();
                        //show success msg
    ...
    /**
     * ["Login" button displayed in message after creating account]
     */
    ...
    /**
     * ["Back to home" button displayed in message after saving data]
     */
